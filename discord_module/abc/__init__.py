"""
Discord abc submodule - FORCED PY-CORD COMPATIBILITY MODE
"""
...
def __getattr__(name):
    ...
    try:
        import importlib
        real_module = importlib.import_module("discord.abc")
        return getattr(real_module, name)
    except (ImportError, AttributeError):
        raise AttributeError(f"Module 'discord.abc' has no attribute '{name}'")
