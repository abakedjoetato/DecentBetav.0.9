"""
Discord ext submodule - FORCED PY-CORD COMPATIBILITY MODE
"""
...
def __getattr__(name):
    ...
    try:
        import importlib
        real_module = importlib.import_module("discord.ext")
        return getattr(real_module, name)
    except (ImportError, AttributeError):
        raise AttributeError(f"Module 'discord.ext' has no attribute '{name}'")
